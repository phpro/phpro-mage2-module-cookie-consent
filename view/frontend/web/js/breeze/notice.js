...
(function () {
    ...
    $.view('phpro-cookie-notice', {
        component: 'Phpro_CookieConsent/js/notice',
        options: {
            default: 'value'
        },
        ...
        create: function () {
            ...
            if (!$.mage.phpprocookie().consentCookieExists(options.cookie_name)) {
            ...
            // file Phpro/CookieConsent/view/frontend/web/js/breeze/modal/preferences.js not loading properly, so added here
